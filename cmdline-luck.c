/*
  ...
  gengetopt --file-name=cmdline-luck
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -t, --time=INT  Time to spin for, mainly for testing",
    0
};
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->time_help = gengetopt_args_info_help[2] ;
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 't':	/* Time to spin for, mainly for testing.  */
